...
function renderDeliveryChart() {
  ...
  section.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
      ...
      <div style="background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius);padding:16px;">
        <div id="ws-table-header" style="font-size:12px;font-weight:700;color:var(--text-muted);text-transform:uppercase;margin-bottom:10px;">🏭 Năng lực sản xuất theo xưởng</div>
        <div id="ws-table-content">
  ...
  // === Day detail view function ===
  function showDayDetail(dateStr) {
    const header = document.getElementById('ws-table-header');
    const content = document.getElementById('ws-table-content');
